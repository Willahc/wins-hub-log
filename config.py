...
class Config:
    ...
    CORREDORES = {
        "SPâ†’DF": {
            ...
            "assimetria": "79,2%",
            "municipios": [
                "SANTA GERTRUDES", "GUARULHOS", "CAJAMAR", "SAO PAULO",
                "BARUERI", "CORDEIROPOLIS", "LIMEIRA", "ARARAS",
        ...
        "SCâ†’SP": {
            ...
            "assimetria": "84,3%",
            "municipios": [
                "JOINVILLE", "BLUMENAU", "ITAJAI", "CHAPECO",
                "CRICIUMA", "FLORIANOPOLIS", "LAGES", "JARAGUA DO SUL",
        ...
        "MSâ†’PR": {
            ...
            "municipios": [
                ...
                "PARANAIBA", "SIDROLANDIA", "NOVA ANDRADINA", "NAVIRAI",
            ],
        },
    }
    ...
    RNTRC_META_URL    = f"https://dados.antt.gov.br/api/3/action/resource_show?id={RNTRC_RESOURCE_ID}"
